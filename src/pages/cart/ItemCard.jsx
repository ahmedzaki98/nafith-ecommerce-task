  ...
  return (
    <div key={product._id}>
      <div class="rounded-3xl border-2 border-gray-200 p-4 lg:p-8 grid grid-cols-12 mb-8 max-lg:max-w-lg max-lg:mx-auto gap-y-4 ">
        <div class="col-span-6 lg:col-span-2 img box">
          <img
            src={product.image}
            alt={product.title}
            class="max-lg:w-full lg:w-[120px]"
          />
        </div>
          ...
          <div class="flex items-center justify-between w-full mb-4">
            ...
            <button
              onClick={() => {
                ...
                toast.error(t("cart.removedProduct"));
              }}
          ...
          <div class="flex justify-between items-center">
            <div class="flex items-center gap-4">
              ...
              {/* <input
                ...
                placeholder="2"
              /> */}
              <div className="flex justify-center items-center border border-gray-200 rounded-full w-10 aspect-square outline-none text-gray-900 font-semibold text-sm py-1.5 px-3 bg-gray-100  text-center">
                {product.quantity}
              </div>
              <button
            ...
            <h6 class="text-primary font-manrope font-bold text-2xl leading-9 text-right">
              ${product.price}
            </h6>
          </div>
        </div>
