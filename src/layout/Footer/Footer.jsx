        ...
        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div class="">
            <h6 class="mb-4 flex items-center justify-center font-semibold uppercase md:justify-start">
              ...
              You & Me <span className="text-primaryVariant pl-1">Shop</span>
            </h6>
            <p
              className={`${
          ...
          <div className="flex flex-col md:justify-center items-start">
            ...
            <p class="mb-4">{t("footer.Clothes")}</p>
            <p class="mb-4">{t("footer.electronics")}</p>
            <p class="mb-4">{t("footer.jewelery")}</p>
          </div>
          <div className="flex flex-col md:justify-start items-start">
            ...
            <Link to="/cart">
              <p class="mb-4">{t("footer.cart")}</p>
            </Link>
            <Link to="/add-product">
              <p class="mb-4">{t("navbar.AddProduct")}</p>
            </Link>
          </div>
          <div>
            <h6 class="mb-4 flex justify-center font-semibold uppercase md:justify-start">
